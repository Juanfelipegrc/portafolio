...
export const Header = () => {
  ...
  return (
    <>
        ...
        <div className={`grid grid-cols-12 ${scrollY === 0? 'bg-black text-white' : 'bg-black text-white'} transition-all duration-500 h-28 items-center w-full fixed top-0 z-[998]`}>
