    ...
    <>
        ...
        <AnimatePresence>

            {
                ...
                >
                    <div className='bg-black no-scroll-bar shadow-[0_0.1rem_0.8rem_rgba(255,255,255,0.25)] w-[85%] md:w-[70%] lg:w-[65%] h-[65%] md:h-[70%] lg:h-[60%] px-3 py-10 sm:p-7 md:px-12 md:py-16 lg:px-14 lg:py-16 rounded-xl overflow-y-scroll overflow-x-hidden relative'>
